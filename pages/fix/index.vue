                        ...
                        >
                            ...
                            <tbody v-if="items.length != 0">
                                <tr v-for="(it, idx) in items" :key="idx">
                                    ...
                                    <td>
                                        {{
                                            selectOptions.asset_types_array[
                                                it.asset.asset_type_id
                                            ]
                                        }}
                                    </td>
                                    <td>
                                            ...
                                            <i
                                                ...
                                                @click="
                                                    () => {
                                                        ...
                                                        item.status =
                                                            selectOptions.fix_statuses.find(
                                                                (x) => {
                                                                    return (
                                                                        x.id ==
                                                                        it.status
                ...
                <div class="modal-body">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-12">
                                <label for="fix-price" class="col-form-label"
                                    >ราคา :</label
                                >
                                <input
                                    type="number"
...
const onDelete = async (id) => {
    await $fetch(`${runtimeConfig.public.apiBase}/repair-history/${id}`, {
        method: "delete",
    })
        .then((res) => {
            if (res.msg == "success") {
