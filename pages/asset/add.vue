<template>
        ...
        <div class="col-xxl-12">
          <div class="breadcrumb__content p-relative z-index-1">
            <div class="breadcrumb__list">
              ...
              <span>
                <NuxtLink href="/asset"> รายการครุภัณฑ์ </NuxtLink>
              </span>
              <span class="dvdr"><i class="fa-solid fa-circle-small"></i></span>
  ...
  <section class="portfolio__area pt-40 pb-40">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h4>แบบฟอร์มเพิ่มข้อมูลครุภัณฑ์</h4>
        </div>
...
const onSubmit = async () => {
  ...
  let type_object = {
    ...
    method: "post",
    url: runtimeConfig.public.apiBase + "/asset/",
  };
  ...
  let data = {
    ...
    is_transfer:
      item.value.is_transfer == null ? undefined : item.value.is_transfer.value,
    cancel_type:
      item.value.cancel_type == null ? undefined : item.value.cancel_type.value,
    inspection_date: dayjs(item.value.inspection_date).format("YYYY-MM-DD"),
    approved_date: dayjs(item.value.approved_date).format("YYYY-MM-DD"),
