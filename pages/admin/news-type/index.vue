    ...
    <div class="container">
      <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
        <h4>
          ...
          <span class="ml-10">รายการประภทข่าว</span>
        </h4>
      </div>
      <div class="mb-30">
        <button
...
const onDelete = async (id) => {
  await $fetch(`${runtimeConfig.public.apiBase}/news-type/${id}`, {
    method: "delete",
  })
    .then((res) => {
      if (res.msg == "success") {
...
const onSubmit = async () => {
  ...
  let type_object = {
    ...
    method: "post",
    url: runtimeConfig.public.apiBase + "/news-type/",
  };
