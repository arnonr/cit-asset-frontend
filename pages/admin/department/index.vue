    ...
    <div class="container">
      <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
        <h4>
          ...
          <span class="ml-10">รายการฝ่ายงาน</span>
        </h4>
      </div>
      <div class="mb-30">
        <button
            ...
            <table class="table table-bordered table-striped table-admin">
              ...
              <tbody v-if="items.length != 0">
                <tr v-for="(it, idx) in items" :key="idx">
                  <td cla ss="text-center">{{ it.name_th }}</td>
                  <td class="text-center">
                    {{ it.name_en }}
                  </td>
                  <td class="text-center">{{ it.level }}</td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form>
            <div class="row">
              <div class="col-12">
                <label for="name-th" class="col-form-label"
                  ><span class="text-danger">*</span>ชื่อฝ่ายงาน (TH) :</label
                >
                <input
                  type="text"
                  ...
                  placeholder="ชื่อฝ่ายงาน (TH)"
                />
              </div>

              <div class="col-12 mt-10">
                <label for="name-en" class="col-form-label"
                  ><span class="text-danger">*</span>ชื่อฝ่ายงาน (EN) :</label
                >
                <input
                  type="text"
                  class="form-control form-control-plaintext"
                  ...
                  placeholder="ชื่อฝ่ายงาน (EN"
                />
              </div>

              <div class="col-12 mt-10">
                <label for="level" class="col-form-label"
                  ><span class="text-danger">*</span>ลำดับ :</label
                >
                <input
                  type="text"
                  class="form-control form-control-plaintext"
              ...
              <div class="col-12 mt-10">
                <label for="is-publish" class="col-form-label"
...
const onDelete = async (id) => {
  await $fetch(`${runtimeConfig.public.apiBase}/department/${id}`, {
    method: "delete",
  })
    .then((res) => {
      if (res.msg == "success") {
...
const onSubmit = async () => {
  ...
  let type_object = {
    ...
    method: "post",
    url: runtimeConfig.public.apiBase + "/department/",
  };
