      ...
      <div class="row">
        ...
        >
          <v-select
            ...
            v-model="search.equipment_department_id"
    ...
    <div class="container">
      <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
        <h4>
          ...
          <span class="ml-10">รายการเครื่องมือ</span>
        </h4>
      </div>
      <div class="mb-30">
        <button
...
const fetchItems = async () => {
  let params = {
    ...
    equipment_department_id:
      search.value.equipment_department_id == null
        ? undefined
        : search.value.equipment_department_id.value,
