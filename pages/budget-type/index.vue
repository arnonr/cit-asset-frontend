    ...
    <div class="container">
      <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
        <h4>
          ...
          <span class="ml-10">รายการแหล่งเงิน</span>
        </h4>
      </div>
      <div class="mb-30">
        <button
            ...
            <div class="row">
              <div class="col-12">
                <label for="code" class="col-form-label"
                  ><span class="text-danger">*</span>รหัสแหล่งเงิน :</label
                >
                <input
                  type="text"
              ...
              <div class="col-12">
                <label for="name" class="col-form-label"
                  ><span class="text-danger">*</span>ชื่อแหล่งเงิน :</label
                >
                <input
                  type="text"
                  class="form-control form-control-plaintext"
...
const onSubmit = async () => {
  ...
  let type_object = {
    ...
    method: "post",
    url: runtimeConfig.public.apiBase + "/budget-type/",
  };
